...
import mod.bespectacled.modernbetareleaseplus.datafix.ModDataFixers;
...
public class ModernBetaReleasePlus {
    ...
    public static final String MODERN_BETA_MODID = "required-after:modernbetaforge@[1.10.0.0,1.11.0.0);";
